...
public:
    inline bool prepare() {
        ...
        if (!_shaderProgram.initWithPath("Shaders/VertexTransform.vert", "Shaders/FragmentTexture.frag")) {
            return false;
        }
    ...
    inline void render() {
        ...
        GLuint transformLoc = glGetUniformLocation(_shaderProgram.Id(), "transform");
